...
define('PASSWORD', '');
define('NOMBRE_BD', 'afr');//Nombre de la Base de datos
...
//Pestañas principales (basicas o  comunes) de la web
	...
	*/
	define("SERVIDOR", "http://localhost/afr");//carpeta raiz (la que contiene todos los archivos para el funcionamiento de la página)
