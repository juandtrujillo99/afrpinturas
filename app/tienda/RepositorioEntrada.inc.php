...
class RepositorioEntradaTienda {
    ...
    public static function obtener_tres_por_fecha_descendente($conexion) {
        $entradas = [];

        if (isset($conexion)) {
            try {
                $sql = "SELECT * FROM tienda ORDER BY fecha DESC LIMIT 3";//aqui se modifica el numero de entradas que deben aparecer en una pagina especifica
    ...
    public static function obtener_entradas_admin_fecha_descendente($conexion, $id_admin) {//Con esta funcion se muestra en el gestor de proyectos todas las entradas de todos los admins
        $entradas_obtenidas = [];
