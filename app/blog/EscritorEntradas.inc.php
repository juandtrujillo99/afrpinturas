...
class EscritorEntradasBlog {
    ...
    public static function escribir_preview_entradas($entrada) {
        ...
        ?>
        <a href="<?php echo RUTA_ENTRADA_BLOG . '/' . $entrada -> obtener_url() ?>" class="col-md-3 col-12">
            <div title="<?php echo $entrada -> obtener_titulo();?>">
                <div class="row bg-image" style="border: 0;">                    
                    <div class="texto-contenido4 ">
                        <div class="img-entrada bg-cover" style="background-image:url(<?php echo RUTA_BLOG_COVER.$entrada -> obtener_imagen(); ?>);"></div>
                        <p class="textoBookBold mayusculas" style="font-size: 1em;padding-top: 1em;word-wrap: break-word;"><?php echo EscritorEntradasBLOG::resumir_titulo(nl2br($entrada -> obtener_titulo()));?></p>
                    </div>       
                </div>
            </div>
        </a>
