...
if (isset($_POST['guardar-restricciones'])) {
	$restricciones = $_POST['restricciones'];	
	if (isset($restricciones)&&!empty($restricciones)) {
		$restricciones_actualizado = RepositorioUsuario::actualizar_restricciones(Conexion::obtener_conexion(), $id_usuario, $restricciones);?>
