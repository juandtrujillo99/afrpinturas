    ...
    <div class="col-10 col-md-4 row" align="center">
        ...
        <div id="actualizar" class="modal bottom-sheet col-12 col-md-12" style="max-height: 100%;">    
            ...
            <div style="background-color:#180D45;padding: 3em 0;">
                <p class="textoBold textoParrafo1a white-text mayusculas">CONFIGURACIÓN DE TU foto del perfil</p>
            </div>
            <div>
                <form class="text-center row" action="<?php echo RUTA_PERFIL; ?>" method="post" enctype="multipart/form-data">
                    <?php
    if(file_exists(DIRECTORIO_RAIZ."/assets/fotos-perfil/usuario/".$usuario->obtener_telefono()."foto")) {
                        ?>  
                    <div class="col-12 col-md-6" style="padding: 2em 0;border-right: solid 1px grey;">
                        <br>
                        <a target="_blank" class="btn btn-principal-animado" href="<?php echo SERVIDOR.'/assets/fotos-perfil/usuario/'.$usuario->obtener_telefono()."foto"; ?>" data-lightbox="Foto de perfil" data-title="Foto de perfil">Ver foto</a>
        ...
        <a class="modal-trigger col-12 col-md-4" href="#actualizar">
            <div align="center">   
                <div class="img-profile bg-cover circle" style="background-color: black;margin-top: -5em;background-image:url(<?php echo SERVIDOR.'/assets/fotos-perfil/usuario/'.$usuario->obtener_telefono()."foto"; ?>);"></div>
