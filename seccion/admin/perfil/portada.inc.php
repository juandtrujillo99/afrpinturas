...
<div class="row col-12" style="margin-top: 2em;">
    ...
    <div class="col-md-3 d-none d-sm-block" style="height:115vh;box-shadow: 0px 0px 23px -4px rgba(0,0,0,0.75);position: absolute;z-index: 2;">
        <div class="row bg-image" style="background-image: url(<?php echo RUTA_IMG_OPTIMIZADA;?>fondo/profile-cover.webp);">
            ...
            <div class="col-10" style="margin-top: 8em;margin-bottom:2em ;">
                ...
                <div id="actualizar" class="modal bottom-sheet col-12 col-md-12" style="max-height: 100%;">    
                    ...
                    <div style="background-color:#180d45;padding: 3em 0;">
                        <p class="textoBold textoSubtitulo white-text">Configuración de la foto de perfil</p>
                    </div>
                    <div>
                        <form class="text-center row" action="<?php echo RUTA_PERFIL_ADMIN; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="d-block d-sm-none col-1"></div>
                            <div class="col-10 center" style="padding: 4em 0;">            
            ...
            ?>
                ...
                <div class="col-12 row">
                    ...
                    <div class="col-12 row center" style="padding-top:2em;">
                        <div class="col-12">
    ...
    <div class="d-block d-sm-none col-12" style="padding: 2em 0;box-shadow: 0px 0px 23px -4px rgba(0,0,0,0.75);">
        <div class="row bg-image" style="background-image: url(<?php echo RUTA_IMG_OPTIMIZADA;?>fondo/profile-cover.webp);">
            <div class="col-1"></div>
            <div class="col-10" style="margin-top: 8em;margin-bottom:2em ;">
                        ...
                        if (count($array_usuarios) > 0) {
                            ...
                            <div class="col-12 row">                                 
                                ...
                                for ($i = 0; $i < count($array_usuarios); $i++) {
                                    ...
                                    ?>   
                                <div class="col-md-1 col-4" style="padding: .1em;">                           
                                    <img loading="lazy" itemprop="image" class="imagen circle tooltipped" data-position="center" data-tooltip="<?php echo $usuario_actual->obtener_nombre(); ?>" src="<?php echo SERVIDOR.'/assets/fotos-perfil/usuario/'.$usuario_actual->obtener_telefono()."foto"; ?>">
                                </div>                                
                                    <?php
                                }
                                ?>                                                                           
                            ...
                            ?>
                            <h3 class="text-center">No hay nadie en el equipo</h3>
                            <br>
                            <br>
                            <?php
                        }
