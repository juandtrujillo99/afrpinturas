<div class="row section">
    ...
    <div class="col-12 col-md-7 row valign-wrapper">
    	...
    	<div class="col-md-9">
			...
			<label for="file1" id="label-archivo" class="btn btn-principal-animado">Seleccionar</label>		
    ...
    <div class="col-12 row valign-wrapper">
    	...
    	<div class="col-md-10 row">
    		...
    		<div class="input-field col-md-6 col-12">
				...
				<label for="titulo">Escribe el nombre del proyecto</label>
			</div>
			<div class="col-1"></div>
			<div class="d-none input-field col-md-5 col-12">
				<input type="number" name="url_externa" id="url_externa" class="validate">
				<label for="url_externa"></label>
			</div>	
			...
			<div class="d-none input-field col-md-6 col-12">
...
<div class="row section" id="descripcion-texto">
    ...
    <div class="col-12 row valign-wrapper">
    	...
    	<div class="col-md-10 row">
    		<div class="col-12">
    			<p class="textoBlack mayusculas" style="font-size: 1.2em;">Agrega más detalles sobre el proyecto</p>
    		</div>
			<div class="input-field col-12">
				...
				<label for="texto">Características, descripción, fotos, etc</label>
				<p>
