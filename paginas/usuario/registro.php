...
<div class="container-fluid">
	...
	<div class="row">
	    ...
	    <div class="col-12 center-align valign-wrapper">
	        <div class="row">
	        	<h1 class="textoBlack" style="margin-top: 2em;margin-bottom: .5em;">Registro de miembros del equipo <?php echo $nombreEmpresa ?> </h1>
	        </div>
	    </div>
