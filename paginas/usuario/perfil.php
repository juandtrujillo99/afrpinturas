	...
	<div class="row center-align valign-wrapper" style="padding: 2em;">
	    <div class="col-12 col-md-6 row">
	        <ul class="collapsible col-12">
				<li>
					<div align="left" class="collapsible-header col-12 valign-wrapper" style="background-color: #180d45; color: white;">
					...
					<div align="left" class="collapsible-body" style="background-color:transparent;">
						<div class="row">
							<div class="col-12">
								...
								<br><hr>
								<div class="col-12 row">	
									<div class="col-11"><p class="textoBook">Bio:</p></div>
									<div class="col-1"><a class="col modal-trigger textoColorMarca" href="#cambiarRestricciones"><i class="fa-solid fa-pen"></i></a></div>	
									<div class="col-12">				
										<?php 
...
<!-- Modal para cambio de restricciones -->
<div id="cambiarRestricciones" class="modal center-align">
	<div class="modal-content">
		<p class="textoBlack textoParrafo">Actualiza tu Bio</p>
		<br>
		<form role="form" method="post" action="<?php echo RUTA_PERFIL; ?>">
			<div class="input-field">
				<input type="text" name="restricciones" class="validate">
				<label for="restricciones">Bio</label>
			</div>
			<button type="submit" class="btn btn-secundario-animado" name="guardar-restricciones">Actualizar</button>
		</form>
	</div>
</div>
