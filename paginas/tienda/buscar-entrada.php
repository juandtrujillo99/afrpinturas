	...
	<div class="col-12">
		<div class="row">		
			...
			if (isset($_POST['termino-buscar-tienda']) && count((array)$resultados)) {
				?>
			<div class="col-12">
				<p align="left"><?php echo count($resultados)." resultado(s) para tu búsqueda";?></p>
				<hr>			
			</div>
				<?php
			...
			if (isset($_POST['buscar-tienda'])) {
				...
				<div class="col-12 row" style="margin-top: 3em;">
					<?php EscritorEntradasTienda::mostrar_entradas_busqueda($resultados); ?>
					<hr><br>			
				</div>
				<?php
				} else {
						...
						<div class="row section d-none d-sm-block">
						    ...
						    <div class="sobreponer d-none d-sm-block">
						        <div class="imagen-background">
						            <img loading="lazy" src="<?php echo RUTA_IMG_OPTIMIZADA;?>otras/patern-1.webp" class="imagen-4">
						            <img loading="lazy" style="position: absolute;right: 0" src="<?php echo RUTA_IMG_OPTIMIZADA;?>otras/patern-2.webp" class="imagen-3">
						        </div>        
						        <div class="texto-contenido col-5">
						            <p style="font-size: 3em;padding-bottom: .5em;" class="textoBookBold">Lo sentimos</p>
						            <p style="font-size: 1.3em;padding-bottom: 1em;line-height: 1.5em;" class="textoBookBold">No encontramos coincidencias. Intenta buscar nuevamente usando otras palabras o vuelve atrás tocando el botón de abajo.</p>
