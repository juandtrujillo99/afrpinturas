...
define('NOMBRE_SERVIDOR', 'sql203.byethost15.com'); //se deja así
define('NOMBRE_USUARIO', 'b15_37308464'); //nombre de usuario de la base de datos
define('PASSWORD', 'elprimero');
define('NOMBRE_BD', 'b15_37308464_afr');//Nombre de la Base de datos
...
//Pestañas principales (basicas o  comunes) de la web
	...
	*/
	define("SERVIDOR", "http://afrpinturas.byethost15.com");//carpeta raiz (la que contiene todos los archivos para el funcionamiento de la página)
