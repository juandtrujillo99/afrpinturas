...
if($partes_ruta[0] == 'afrpinturas.byethost15.com'){
	if (count($partes_ruta) == 1) {
		...
		switch($partes_ruta[1]){
			...
			//pagina donde estan todas las vistas prvias de los proyectos
			case 'work':
			...
			break;
			//pagina de zonas concurridas
			case 'commercial':
			$ruta_elegida = 'paginas/zonas.php';
			break;
			//pagina de blog
			case 'blog':
			...
			//link tree
			case 'design-1':
			$ruta_elegida = 'paginas/linktree.php';
			break;
			...
			$ruta_elegida = 'paginas/politica-privacidad.php';
			break;
			//terminos y condiciones
			case 'politica-cookies':
			$ruta_elegida = 'paginas/politica-cookies.php';
			break;
			//pagina donde estan todas las imagenes que se utilizan en la seccion categorias
			...
			//pagina para mostrador de oficina
			case 'video1':
			$ruta_elegida = 'paginas/videos/1.php';
			break;
			case 'video2':
			$ruta_elegida = 'paginas/videos/2.php';
			break;
			case 'video3':
			$ruta_elegida = 'paginas/videos/3.php';
			break;
			case 'video4':
			$ruta_elegida = 'paginas/videos/4.php';
			break;
			case 'video5':
			$ruta_elegida = 'paginas/videos/5.php';
			break;
			case 'video6':
			$ruta_elegida = 'paginas/videos/6.php';
			break;
			case 'video7':
			$ruta_elegida = 'paginas/videos/7.php';
			break;
			case 'video8':
			$ruta_elegida = 'paginas/videos/8.php';
			break;
			case 'video9':
			$ruta_elegida = 'paginas/videos/9.php';
			break;
			case 'video10':
			$ruta_elegida = 'paginas/videos/10.php';
			break;
			case 'video11':
			$ruta_elegida = 'paginas/videos/11.php';
			break;
			case 'video12':
			$ruta_elegida = 'paginas/videos/12.php';
			break;
			case 'video13':
			$ruta_elegida = 'paginas/videos/13.php';
			break;
			case 'video14':
			$ruta_elegida = 'paginas/videos/14.php';
			break;
			case 'video15':
			$ruta_elegida = 'paginas/videos/15.php';
			break;
			case 'video16':
			$ruta_elegida = 'paginas/videos/16.php';
			break;
			case 'video17':
			$ruta_elegida = 'paginas/videos/17.php';
			break;
			case 'video18':
			$ruta_elegida = 'paginas/videos/18.php';
			break;
			case 'clima':
			$ruta_elegida = 'paginas/videos/clima.php';
			break;
			case 'hora':
			$ruta_elegida = 'paginas/videos/hora.php';
			break;
		...
		if ($partes_ruta[1] == 'entrada-blog') {
			...
			if ($entrada != null) {
				...
				$entradas_azar = RepositorioEntradaBlog::obtener_entradas_al_azar(Conexion::obtener_conexion(), 2);//aqui se cambia el numero de entradas que se va a mostrar
		...
		if ($partes_ruta[1] == 'servicio') {
			...
			if ($entrada != null) {
				...
				$entradas_azar = RepositorioEntradaTienda::obtener_entradas_al_azar(Conexion::obtener_conexion(), 2);//aqui se cambia el numero de entradas que se va a mostrar
